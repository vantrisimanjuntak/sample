                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form class="user" action="<?= base_url('login/verify') ?>" method="POST">
                                        ...
                                        <div class="form-group">
                                            <input type="password" class="form-control form-control-user" placeholder="Password" id="exampleInputPassword" name="password">
                                        </div>
